<footer class="footer__section footer__bg">
        <div class="container">
            <div class="main__footer section--padding">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="index.html"><img class="footer__logo--img display-block" src="assets/img/logo/footer-logo.png" alt="footer-logo"></a>
                    ...
                    <div class="col-lg-2 col-md-6">
                        <div class="footer__widget">
                            <h2 class="footer__widget--title ">Panchakarma <button class="footer__widget--button" aria-label="footer widget button"></button>
                                <svg class="footer__widget--title__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12.355" height="8.394" viewBox="0 0 10.355 6.394">
                                    <path  d="M15.138,8.59l-3.961,3.952L7.217,8.59,6,9.807l5.178,5.178,5.178-5.178Z" transform="translate(-6 -8.59)" fill="currentColor"></path>
                                </svg>
                            </h2>
  ...
  <li class="footer__widget--menu__list text-white"><strong> Email -</strong> madhavayurgram@gmail.com</li><br/>
    <li class="footer__widget--menu__list text-white"><strong> Email -</strong> 9969606111</li>                         
                                <li class="footer__widget--menu__list text-white"><strong> Address - 1</strong> GIRIJA CLINIC: Shop No. 1, Tukaram Mhatre Chawl, Datta Mandir Road, Penkarpada, Mira Road (E), Thane 401 107</li>
                                <li class="footer__widget--menu__list text-white"><strong> Address - 2</strong> AYURVEDA: Shop No. 5, Bldg. No. 10, Sector 4, Shanti Garden, Opp. MBMC Garden, Mira Road (E), Thane 40110</li>
                            </ul>
                        </div>
                    </div>
                    <!--<div class="col-lg-4 col-md-6">
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content  m-0">Copyright © 2023 <a class="copyright__content--link" href="index.html">Mahrshi Madhav Ayurgram.</a> All Rights Reserved.</p>
                <p class="footer__bottom--desc"><a href="privacy-policy.html">Designed By - WebVision Softech PVT LTD.</a></p>
            </div>
        </div>
    </footer>
    <!-- End footer section -->
